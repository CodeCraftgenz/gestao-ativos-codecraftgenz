...
-- ============================================================================
-- PARTE 11: CRIAR TABELA DE PRE-REGISTRO DE DISPOSITIVOS
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS pre_registered_devices (
  ...
  CONSTRAINT fk_pre_reg_filial FOREIGN KEY (filial_id) REFERENCES filiais(id) ON DELETE SET NULL,
  CONSTRAINT fk_pre_reg_user FOREIGN KEY (registered_by) REFERENCES users(id) ON DELETE CASCADE,
  CONSTRAINT fk_pre_reg_device FOREIGN KEY (device_id) REFERENCES devices(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
